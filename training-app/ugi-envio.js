/* ==========================================================================
   ...
   Archivo: training-app/ugi-envio.js
   --------------------------------------------------------------------------
...
window.UGI = (function () {
  ...
  const DATABASE_URL =
    "https://script.google.com/macros/s/AKfycbyfvPeuupcXI5K2HYMBMiuQgr-xzNWH-lqvG25gVNAbpSA6_3gm-sSQ7BpWXkvyGOUw/exec";
